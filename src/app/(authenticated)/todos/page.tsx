    ...
    <div className="mx-auto max-w-2xl px-4 py-6">
      ...
      <form onSubmit={handleAdd} className="mb-6 flex gap-2">
        <input
          ...
          className="flex-1 rounded-lg border border-border bg-input px-3 py-2 text-app placeholder-gray-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
          maxLength={500}
        />
        <button
          type="submit"
          ...
          <div className="mx-auto max-w-2xl">
            ...
            <label className="mb-4 block">
              ...
              <select
                ...
                className="w-full rounded-lg border border-border bg-input px-3 py-2 text-app focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
              >
