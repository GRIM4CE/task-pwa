        ...
        {step === "init" && (
          <div className="space-y-4">
            <div className="rounded-lg border border-border bg-surface p-4 text-sm text-text-muted">
              <p className="font-medium text-text">You&apos;ll need an authenticator app:</p>
          ...
          <form onSubmit={handleVerify} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-2 block w-full rounded-lg border border-border bg-surface px-3 py-3 text-center text-2xl tracking-[0.3em] text-text placeholder-text-muted focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                placeholder="000000"
                autoFocus
              />
            </div>
        ...
        {step === "recovery" && (
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-text-muted hover:bg-surface-hover"
            >
              Copy all codes
            </button>
