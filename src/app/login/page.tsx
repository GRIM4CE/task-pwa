          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-lg border border-border bg-input px-3 py-2 text-text placeholder-gray-400 focus:border-focus focus:outline-none focus:ring-1 focus:ring-focus"
                placeholder="admin"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-lg border border-border bg-input px-3 py-2 text-center text-2xl tracking-[0.3em] text-text placeholder-gray-400 focus:border-focus focus:outline-none focus:ring-1 focus:ring-focus"
                placeholder="000000"
              />
            </div>
          ...
          <form onSubmit={handleRecovery} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-lg border border-border bg-input px-3 py-2 text-center text-lg tracking-wider text-text placeholder-gray-400 focus:border-focus focus:outline-none focus:ring-1 focus:ring-focus font-mono"
