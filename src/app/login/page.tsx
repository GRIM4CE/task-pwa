          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-lg border border-border bg-white px-3 py-2 text-text placeholder-gray-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                placeholder="admin"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-lg border border-border bg-white px-3 py-2 text-center text-2xl tracking-[0.3em] text-text placeholder-gray-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                placeholder="000000"
              />
            </div>
          ...
          <form onSubmit={handleRecovery} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-lg border border-border bg-white px-3 py-2 text-center text-lg tracking-wider text-text placeholder-gray-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary font-mono"
